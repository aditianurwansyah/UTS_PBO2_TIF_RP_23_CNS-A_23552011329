...
public class DatabaseConnection {
    private static final String URL = "jdbc:mysql://localhost:3307/asuransi_sistem"; // Ganti 'your_database_name' dengan nama database Anda
    ...
    // Metode untuk memeriksa apakah koneksi masih terbuka
